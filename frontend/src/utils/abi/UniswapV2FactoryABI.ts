export const UniswapV2FactoryABI = [
  ...
  {
    inputs: [{ internalType: "address", name: "_dibs", type: "address" }],
    name: "setDibs",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address", name: "_feehandler", type: "address" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_tresFee", type: "uint256" }],
    name: "setTreasuryFee",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",

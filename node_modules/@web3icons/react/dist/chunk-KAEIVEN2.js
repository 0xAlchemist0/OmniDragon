...
__export(networks_exports, {
  ...
  NetworkArbitrumOne: () => NetworkArbitrumOne_default,
  ...
  NetworkBerachain: () => NetworkBerachain_default,
  NetworkBinanceSmartChain: () => NetworkBinanceSmartChain_default,
  NetworkBitcoin: () => NetworkBitcoin_default,
  NetworkBitkubChain: () => NetworkBitkubChain_default,
  NetworkBlast: () => NetworkBlast_default,
  NetworkBob: () => NetworkBob_default,
  NetworkBoba: () => NetworkBoba_default,
  NetworkBotanix: () => NetworkBotanix_default,
  NetworkBouncebit: () => NetworkBouncebit_default,
  NetworkCardano: () => NetworkCardano_default,
  NetworkCelo: () => NetworkCelo_default,
  NetworkChiliz: () => NetworkChiliz_default,
  NetworkClover: () => NetworkClover_default,
  NetworkCoinexSmartChain: () => NetworkCoinexSmartChain_default,
  NetworkConflux: () => NetworkConflux_default,
  NetworkCorn: () => NetworkCorn_default,
  NetworkCosmos: () => NetworkCosmos_default,
  NetworkCosmosHub: () => NetworkCosmosHub_default,
  NetworkCronos: () => NetworkCronos_default,
  NetworkCronosZkevm: () => NetworkCronosZkevm_default,
  NetworkDiode: () => NetworkDiode_default,
  NetworkDogechain: () => NetworkDogechain_default,
  NetworkEdgeless: () => NetworkEdgeless_default,
  NetworkElastos: () => NetworkElastos_default,
  NetworkEnergyWeb: () => NetworkEnergyWeb_default,
  NetworkEnuls: () => NetworkEnuls_default,
  NetworkEos: () => NetworkEos_default,
  NetworkEthereum: () => NetworkEthereum_default,
  NetworkEthereumClassic: () => NetworkEthereumClassic_default,
  NetworkEtherlink: () => NetworkEtherlink_default,
  NetworkExpchain: () => NetworkExpchain_default,
  NetworkFantom: () => NetworkFantom_default,
  NetworkFilecoin: () => NetworkFilecoin_default,
  NetworkFio: () => NetworkFio_default,
  NetworkFlare: () => NetworkFlare_default,
  NetworkFluence: () => NetworkFluence_default,
  NetworkFraxtal: () => NetworkFraxtal_default,
  NetworkFuel: () => NetworkFuel_default,
  NetworkFuse: () => NetworkFuse_default,
  ...
  NetworkKaia: () => NetworkKaia_default,
  ...
  NetworkKujira: () => NetworkKujira_default,
  NetworkL3x: () => NetworkL3x_default,
  NetworkLavaNetwork: () => NetworkLavaNetwork_default,
  NetworkLens: () => NetworkLens_default,
  NetworkLightlink: () => NetworkLightlink_default,
  NetworkLinea: () => NetworkLinea_default,
  NetworkLisk: () => NetworkLisk_default,
  NetworkLitecoin: () => NetworkLitecoin_default,
  NetworkLoopring: () => NetworkLoopring_default,
  NetworkLukso: () => NetworkLukso_default,
  NetworkLumia: () => NetworkLumia_default,
  NetworkLumio: () => NetworkLumio_default,
  NetworkLycan: () => NetworkLycan_default,
  NetworkLyra: () => NetworkLyra_default,
  NetworkMantaPacific: () => NetworkMantaPacific_default,
  NetworkMantle: () => NetworkMantle_default,
  NetworkMantra: () => NetworkMantra_default,
  NetworkMegaEth: () => NetworkMegaEth_default,
  NetworkMeter: () => NetworkMeter_default,
  NetworkMetisAndromeda: () => NetworkMetisAndromeda_default,
  ...
  NetworkMonad: () => NetworkMonad_default,
  NetworkMoonbase: () => NetworkMoonbase_default,
  ...
  NetworkOsmosis: () => NetworkOsmosis_default,
  NetworkOzean: () => NetworkOzean_default,
  NetworkParadex: () => NetworkParadex_default,
  NetworkPeaq: () => NetworkPeaq_default,
  ...
  NetworkReya: () => NetworkReya_default,
  NetworkRollux: () => NetworkRollux_default,
  NetworkRonin: () => NetworkRonin_default,
  NetworkRootstock: () => NetworkRootstock_default,
  NetworkScroll: () => NetworkScroll_default,
  NetworkSeiNetwork: () => NetworkSeiNetwork_default,
  NetworkShiden: () => NetworkShiden_default,
  NetworkShimmerEvm: () => NetworkShimmerEvm_default,
  NetworkSilicon: () => NetworkSilicon_default,
  NetworkSolana: () => NetworkSolana_default,
  ...
  NetworkStellar: () => NetworkStellar_default,
  ...
  NetworkTenet: () => NetworkTenet_default,
  NetworkTheta: () => NetworkTheta_default,
  NetworkThundercore: () => NetworkThundercore_default,
  NetworkTombchain: () => NetworkTombchain_default,
  ...
  NetworkWemix: () => NetworkWemix_default,
  NetworkWorld: () => NetworkWorld_default,
  NetworkXLayer: () => NetworkXLayer_default,
  NetworkXai: () => NetworkXai_default,
  NetworkXdc: () => NetworkXdc_default,
  NetworkXrp: () => NetworkXrp_default,
  NetworkZeroNetwork: () => NetworkZeroNetwork_default,
  NetworkZetaChain: () => NetworkZetaChain_default,
  NetworkZilliqa: () => NetworkZilliqa_default,
  NetworkZircuit: () => NetworkZircuit_default,
  NetworkZksync: () => NetworkZksync_default,
  NetworkZora: () => NetworkZora_default,
  NetworkZyx: () => NetworkZyx_default
});

export { networks_exports };

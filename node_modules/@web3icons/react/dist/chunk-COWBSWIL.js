...
__export(wallets_exports, {
  ...
  WalletMultis: () => WalletMultis_default,
  WalletMyEtherWallet: () => WalletMyEtherWallet_default,
  WalletObvious: () => WalletObvious_default,
  WalletOkx: () => WalletOkx_default,
  WalletPhantom: () => WalletPhantom_default,
  WalletPillar: () => WalletPillar_default,
  WalletPortal: () => WalletPortal_default,
  WalletRabby: () => WalletRabby_default,
  WalletRainbow: () => WalletRainbow_default,
  WalletRonin: () => WalletRonin_default,
  ...
  WalletUnipass: () => WalletUnipass_default,
  WalletVenly: () => WalletVenly_default,
  WalletWallet3: () => WalletWallet3_default,
  WalletWalletConnect: () => WalletWalletConnect_default,
  WalletXdefi: () => WalletXdefi_default,
  WalletZengo: () => WalletZengo_default,
  WalletZerion: () => WalletZerion_default
});
